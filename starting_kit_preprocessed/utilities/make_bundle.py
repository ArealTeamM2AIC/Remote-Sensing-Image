...
class Bundle:
	def __init__(self, starting_kit_dir, big_data_dir):
		...
		self.starting_kit_files = ['README.md', 'README.ipynb', 'scoring_program', 'ingestion_program', 'sample_code_submission', 'sample_data', 'logo.jpg', 'CNN.png', 'requirements.txt']
...
if __name__== "__main__":
	...
	##############################################
	clean_old_bundles = 0			# Remove old bundles 
